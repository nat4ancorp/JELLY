			...
			if($type == "admin"){
				if(isset($_POST['editmodule_publish'])){
					...
					if($error_console!=""){
						...
						mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET status='".$editmodule_status."' WHERE id='".$module."'");														
											...
											<div class="formLayoutTableMainAll">
                                                ...
                                                <div class="formLayoutTableRowMainAll">
													...
													<div class="formLayoutTableRowMainAllRightCol">
														 <select name="editmodule_status">
															<?php if($status=="Drafted"){?><option value="Drafted" selected="selected">Draft</option><?php } else {?><option value="Drafted">Draft</option><?php }?>
															<?php if($status=="Published"){?><option value="Published" selected="selected">Publish</option><?php } else {?><option value="Published">Publish</option><?php }?>
															<?php if($status=="On Hold"){?><option value="On Hold" selected="selected">Hold</option><?php } else {?><option value="On Hold">Hold</option><?php }?>
                                                            <?php if($statue=="Deleted"){?><option value="Deleted" selected="selected" disabled="disabled">Deleted</option><?php } else {?><option value="Deleted" disabled="disabled">Deleted</option><?php }?>
                                                            <?php if($status=="Recovered"){?><option value="Recovered" selected="selected" disabled="disabled">Recovered</option><?php } else {?><option value="Recovered" disabled="disabled">Recovered</option><?php }?>
														 </select>
													</div>
												</div>
