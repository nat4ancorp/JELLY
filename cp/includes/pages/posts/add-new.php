...
if((isset($_POST['_chooser'])) && ($_POST['_chooser']!="") || isset($_POST['post_publish'])){
	...
	<select id="_chooser" style="width:200px;height:35px;vertical-align:text-top;font-size:22px;border:thin solid gray;" onchange="_chooser();">
		<?php
							...
							<div class="formLayoutTableRowMainAll">
								...
								<div class="formLayoutTableRowMainAllRightCol">
									<div id="upload_popup" style="display:none;" class="upload-popup">
										...
										?>
                                        <center><iframe src="<?php echo $WEBSITE_URL_ROOT;?>includes/private/bin/uploader-flashy-enhanced/index.php?id=<?php echo $postid;?>&pop=<?php echo ucfirst($pop);?>&year=<?php echo $postid_dateyear;?>&month=<?php echo $postid_datemonth_word;?>&day=<?php echo $postid_dateday;?>&title=<?php echo $postid_nameclean;?>" style="position:relative; top: 5px;" width="880" height="584"></iframe></center>																				
                                        <?php
						...
						<div class="formLayoutTable">
							<div class="formLayoutTableRow">
								<div class="formLayoutTableRowLeftCol">
									...
									<?php
									$GET_ALL_CATEGORIES=mysql_query("SELECT * FROM {$properties->DB_PREFIX}".$pop."_categories ORDER BY name");
