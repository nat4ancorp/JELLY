...
if($type == "admin"){
	...
	$editpost_startedit=mysql_real_escape_string($_POST['editpost_startedit']);
	...
	$editpost_watchedon=mysql_real_escape_string($_POST['editpost_watchedon']);
	$editpost_donewatching=mysql_real_escape_string($_POST['editpost_donewatching']);
	$editpost_willreviewon=mysql_real_escape_string($_POST['editpost_willreviewon']);
	...
	$editpost_usedbyname=mysql_real_escape_string($_POST['editpost_usedbyname']);
	$editpost_usedbyurl=mysql_real_escape_string($_POST['editpost_usedbyurl']);
	$editpost_openrepo=mysql_real_escape_string($_POST['editpost_openrepo']);
	$editpost_repolink=mysql_real_escape_string($_POST['editpost_repolink']);
	}
	/* END ADDON: WORK */
	
	/* ADDON: WORK */
	if($base=="changelog"){
	$editpost_updatetype=mysql_real_escape_string($_POST['editpost_updatetype']);
	}
	/* END ADDON: WORK */
	...
	if($editpost_startedit=="no"){/* CHECK FOR WILL REVIEW */if($editpost_willreviewon=="0000-00-00" || $editpost_willreviewon==""){$error_console.="<br />You must tell me when you plan to review this since you will start it later";}}
	}
	/* END ADDON: OTHER WORK */
	...
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET watchedon='".$editpost_watchedon."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET donewatchingon='".$editpost_donewatchingon."' WHERE id='".$postid."'");
	if($editpost_startedit=="no"){mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET willreviewon='".$editpost_willreviewon."' WHERE id='".$postid."'");}
	...
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET portfolio_id='".$editpost_portfolio_new_id."' WHERE id='".$postid."'");
	} else {
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET portfolio_id='".$editpost_portfolio."' WHERE id='".$postid."'");	
	}
	...
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET type='".$editpost_type."' WHERE id='".$postid."'");	
	}
	...
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET usedbyname='".$editpost_usedbyname."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET usedbyurl='".$editpost_usedbyurl."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET openrepo='".$editpost_openrepo."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET repo_link='".$editpost_repolink."' WHERE id='".$postid."'");
	}					
	/* END ADDON: WORK */
	
	/* ADDON: CHANGELOG */
	if($base=="changelog"){
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET type='".$editpost_updatetype."' WHERE id='".$postid."'");
	}					
	/* END ADDON: CHANGELOG */
	...
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET dateandtime='' WHERE id='".$postid."'");
	...
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET dateandtime_goingtostart='' WHERE id='".$postid."'");
	}
	
	//make the date_
	//0000-00-00 00:00:00
	//0123456789012345678
	$dateandtime_ind=$editpost_date." ".$editpost_time;
	$editpost_date_year=substr($dateandtime_ind,0,4);
	$editpost_date_month=substr($dateandtime_ind,5,2);
	$editpost_date_day=substr($dateandtime_ind,8,2);
	$editpost_date_hour=substr($dateandtime_ind,11,2);
	$editpost_date_min=substr($dateandtime_ind,14,2);
	$editpost_date_sec=substr($dateandtime_ind,17,2);
	
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET date_year='".$editpost_date_year."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET date_month='".$editpost_date_month."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET date_day='".$editpost_date_day."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET date_hour='".$editpost_date_hour."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET date_min='".$editpost_date_min."' WHERE id='".$postid."'");
	mysql_query("UPDATE {$properties->DB_PREFIX}".$what." SET date_sec='".$editpost_date_sec."' WHERE id='".$postid."'");	
	...
	$postid_addon_watchedon=$FETCH_ENTRY_INFO['watchedon'];
	$postid_addon_donewatchingon=$FETCH_ENTRY_INFO['donewatchingon'];
	$postid_addon_willreviewon=$FETCH_ENTRY_INFO['willreviewon'];
	...
	$postid_usedbyname=mysql_real_escape_string($FETCH_ENTRY_INFO['usedbyname']);
	$postid_usedbyurl=mysql_real_escape_string($FETCH_ENTRY_INFO['usedbyurl']);
	$postid_openrepo=mysql_real_escape_string($FETCH_ENTRY_INFO['openrepo']);
	$postid_repolink=mysql_real_escape_string($FETCH_ENTRY_INFO['repo_link']);
	
	//break apart date
	//0000-00-00 00:00:00
	//0123456789012345678
	if($postid_dateandtime=="0000-00-00 00:00:00"){
	...
	/* ADDON: CHANGELOG */
	if($base=="changelog"){
	$postid_updatetype=$FETCH_ENTRY_INFO['type'];
	}
	/* END ADDON: CHANGELOG */
	...
	?>
	<center>
	<iframe src="<?php echo $WEBSITE_URL_ROOT;?>includes/private/bin/modules/native/uploader-flashy-enhanced/index.php?id=<?php echo $postid;?>&pop=<?php echo ucfirst($pop);?>&year=<?php echo $postid_dateyear;?>&month=<?php echo $postid_datemonth_word;?>&day=<?php echo $postid_dateday;?>&title=<?php echo $postid_nameclean;?>" style="position:relative; top: 5px;" width="880" height="584"></iframe>
	</center>
	<?php
	...
	<div class="formLayoutTableRowMainAll">
	<div class="formLayoutTableRowMainAllLeftCol"> Air Start </div>
	<div class="formLayoutTableRowMainAllRightCol"> 
	<script type="text/javascript">
	$(function() {
	...
	<div class="formLayoutTableRowMainAll">
	<div class="formLayoutTableRowMainAllLeftCol"> Air End </div>
	<div class="formLayoutTableRowMainAllRightCol"> 
	<script type="text/javascript">
	$(function() {
	...
	<?php if($postid_addon_watch_type=="past"){?>
	<option value="past" selected="selected">Watched</option>
	<?php } else {?>
	<option value="past">Watched</option>
	<?php }?>
	<?php if($postid_addon_watch_type=="current"){?>
	<option value="current" selected="selected">Watching Now</option>
	<?php } else {?>
	<option value="current">Watching Now</option>
	<?php }?>
	<?php if($postid_addon_watch_type=="future"){?>
	<option value="future" selected="selected">Need to Watch</option>
	<?php } else {?>
	<option value="future">Need to Watch</option>
	<?php }?>
	</select>
	</div>
	</div>
	...
	<script type="text/javascript">
	$(function() {
	$('#editpost_watchedon').datepick({dateFormat: 'yyyy-mm-dd'});
	//$('#inlineDatepicker').datepick({onSelect: showDate});
	});
	</script> 
	Watched: </div>
	<div class="formLayoutTableRowMainAllRightCol">
	<input type="date" name="editpost_watchedon" value="<?php echo $postid_addon_watchedon;?>" style="width:120px;" />
	</div>
	</div>
	...
	<script type="text/javascript">
	$(function() {
	$('#editpost_donewatchingon').datepick({dateFormat: 'yyyy-mm-dd'});
	//$('#inlineDatepicker').datepick({onSelect: showDate});
	});
	</script> 
	Done W: </div>
	<div class="formLayoutTableRowMainAllRightCol">
	<input type="date" name="editpost_donewatchingon" value="<?php echo $postid_addon_donewatchingon;?>" style="width:120px;" />
	</div>
	</div>
	...
	<script type="text/javascript">
	$(function() {
	$('#editpost_willreviewon').datepick({dateFormat: 'yyyy-mm-dd'});
	//$('#inlineDatepicker').datepick({onSelect: showDate});
	});
	</script> 
	Will Review: </div>
	<div class="formLayoutTableRowMainAllRightCol">
	<input type="date" name="editpost_willreviewon" value="<?php echo $postid_addon_willreviewon;?>" style="width:120px;" />
	</div>
	</div>
	...
	** only put filename.extension </div>
	...
	<div class="formLayoutTableRowMainAllRightCol">
	<?php if($postid_addon_is_installable == "yes"){?>
    ...
    <div class="formLayoutTableRowMainAll">
	<div class="formLayoutTableRowMainAllLeftCol"> Used by [N]</div>
	<div class="formLayoutTableRowMainAllRightCol">
	<input type="text" name="editpost_usedbyname" value="<?php echo $postid_usedbyname;?>" />
	</div>
	</div>
    
    <div class="formLayoutTableRowMainAll">
	<div class="formLayoutTableRowMainAllLeftCol"> Used by [U]</div>
	<div class="formLayoutTableRowMainAllRightCol">
	<input type="text" name="editpost_usedbyurl" value="<?php echo $postid_usedbyurl;?>" />
	</div>
	</div>
    
    <div class="formLayoutTableRowMainAll">
	<div class="formLayoutTableRowMainAllLeftCol"> Repo?</div>
	<div class="formLayoutTableRowMainAllRightCol">
	<?php if($postid_openrepo == "yes"){?>
	<input type="radio" name="editpost_openrepo" value="yes" class="radio" checked="checked" />
	Yes
	<input type="radio" name="editpost_openrepo" value="no" class="radio" />
	No
	<?php } else {?>
	<input type="radio" name="editpost_openrepo" value="yes" class="radio" />
	Yes
	<input type="radio" name="editpost_openrepo" value="no" checked="checked" class="radio" />
	No
	<?php }?>
	</div>
	</div>
    ...
    <div class="formLayoutTableRowMainAll">
	<div class="formLayoutTableRowMainAllLeftCol"> Repo Link</div>
	<div class="formLayoutTableRowMainAllRightCol">
	<input type="text" name="editpost_repolink" value="<?php echo $postid_repolink;?>" />
	</div>
	</div>
	<?php
	}										
	...
	<div class="formLayoutTableRowMainAllLeftCol"> Type </div>
	<div class="formLayoutTableRowMainAllRightCol">
	<select name="editpost_updatetype" style="width:200px;">
	<?php if($postid_updatetype == "MAJOR REL"){?><option value="MAJOR REL" selected="selected">Major Release</option><?php }else{?><option value="MAJOR REL">Major Release</option><?php }?>
	<?php if($postid_updatetype == "GO MAS"){?><option value="GO MAS" selected="selected">Golden Master</option><?php }else{?><option value="GO MAS">Golden Master</option><?php }?>
	<?php if($postid_updatetype == "UPDATE"){?><option value="UPDATE" selected="selected">Update</option><?php }else{?><option value="UPDATE">Update</option><?php }?>
	</select>
	</div>
	</div>
	</div>
...
<?php }}else{?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{if($DEFAULT_ORDER=="dateandtime OR dateandtime_goingtostart"){echo "dateandtime";}else{echo $DEFAULT_ORDER;}}?>&direction=ASC#<?php echo $ITEMS_LIST_LIST[$i];?>">DESC</a>]
<?php }?>
</div>

<div class="formLayoutFullCol alignLeft width-semimedium valignMiddle fontBig BorderTop BorderBottom"> <a href="?menu=posts&page=all-posts&order=author">Author</a> 
<?php if(isset($_GET['direction']) && $_GET['direction']!=""){if($_GET['direction']=="ASC"){?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{echo $DEFAULT_ORDER;}?>&direction=DESC#<?php echo $ITEMS_LIST_LIST[$i];?>">ASC</a>]
<?php }else if($_GET['direction']=="DESC"){?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{echo $DEFAULT_ORDER;}?>&direction=ASC#<?php echo $ITEMS_LIST_LIST[$i];?>">DESC</a>]
...
<div class="formLayoutFullCol alignLeft width-semimedium valignMiddle fontBig BorderTop BorderBottom"> <a href="?menu=posts&page=all-posts&order=category">Categories</a> 
<?php if(isset($_GET['direction']) && $_GET['direction']!=""){if($_GET['direction']=="ASC"){?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{echo $DEFAULT_ORDER;}?>&direction=DESC#<?php echo $ITEMS_LIST_LIST[$i];?>">ASC</a>]
<?php }else if($_GET['direction']=="DESC"){?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{echo $DEFAULT_ORDER;}?>&direction=ASC#<?php echo $ITEMS_LIST_LIST[$i];?>">DESC</a>]
...
<div class="formLayoutFullCol alignLeft width-xsmall valignMiddle fontBig BorderTop BorderBottom BorderRight"> <a href="?menu=posts&page=all-posts&order=dateandtime">Date</a> 
<?php if(isset($_GET['direction']) && $_GET['direction']!=""){if($_GET['direction']=="ASC"){?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{echo $DEFAULT_ORDER;}?>&direction=DESC#<?php echo $ITEMS_LIST_LIST[$i];?>">ASC</a>]
<?php }else if($_GET['direction']=="DESC"){?>
[<a href="?menu=posts&page=all-posts&order=<?php if(isset($_GET['order']) && $_GET['order']!=""){echo $_GET['order'];}else{echo $DEFAULT_ORDER;}?>&direction=ASC#<?php echo $ITEMS_LIST_LIST[$i];?>">DESC</a>]
...
if($icat==count($category_list)-1){$category.="<a href=\"".$WEBSITE_URL."?menu=posts&page=categories&action=edit&what=".$item."_".str_replace("entries","categories",$sub_item)."&pad=".$pad."&pop=".$page."&catid=".$category_id."&base=".$item."&subbase=".str_replace("entries","categories",$sub_item)."\">" . $FETCH_CATEGORY_INFO['name'] . "</a>";}else{$category.="<a href=\"".$WEBSITE_URL."?menu=posts&page=categories&action=edit&what=".$item."_".str_replace("entries","categories",$sub_item)."&pad=".$pad."&pop=".$page."&catid=".$category_id."&base=".$item."&subbase=".str_replace("entries","categories",$sub_item)."\">" . $FETCH_CATEGORY_INFO['name'] . "</a>, ";}
}
}
} else {
...
$category="<a href=\"".$WEBSITE_URL."?menu=posts&page=categories&action=edit&what=".$item."_".str_replace("entries","categories",$sub_item)."&pad=".$pad."&pop=".$page."&catid=".$category_id."&base=".$item."&subbase=".str_replace("entries","categories",$sub_item)."\">".$FETCH_CATEGORY_INFO['name']."</a>";
}	
}
