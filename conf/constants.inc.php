...
const BRANCH							= "Jellycmsdotcom/"; /* *** MUST HAVE TRAILING SLASH *** */
...
const WEBSITE_NAME						= "JELLY CMS";
const WEBSITE_EXT						= "";
const WEBSITE_SLOGAN					= "Just an Essential Liberating Library for You CMS";
const WEBSITE_SLOGAN_SHORT 				= "JELLY CMS";
...
const FULL_WEBSITE_TEST_URL				= "http://localhost/JELLY/Jellycmsdotcom/Versions/Strawberry/base/home";
const FULL_WEBSITE_REMO_URL				= "http://www.jellycms.com/base/home";
const WEBSITE_TEST_URL					= "http://localhost/JELLY/Jellycmsdotcom/Versions/Strawberry/";
...
const FOOTER_AUTHOR_INFO				= "JELLY CMS. A Content Management System. The Interwebs. (555) 555 5555";
...
const DB_NAME 							= "mrnat4an_jellycms";
const DB_PREFIX 						= "h_";

const MAIN_TITLE 						= "Jellycms.com";
const MAIN_TITLE_ALIGN					= "l"; //l = left; c = center; r = right
const MAIN_SLOGAN 						= "Jelly CMS";
...
/* CORE SESSION DATA */
const _COOKIE_INIT_LOCAL_SESSION 		= "jellycms_local_session";
const _COOKIE_INIT_REMOTE_SESSION 		= "jellycms_remote_session";
const _COOKIE_INIT_TEMP_LOCAL_SESSION 	= "jellycms_temp_local_session";
const _COOKIE_INIT_TEMP_REMOTE_SESSION  = "jellycms_temp_remote_session";	
}
?>