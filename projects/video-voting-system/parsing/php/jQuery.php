	...
	if(htmlentities($_POST['action'], ENT_QUOTES, 'UTF-8') == 'rating')
	{
		...
		*/
		...
		if($can_vote="yes"){
			...
			mysql_query("UPDATE {$properties->DB_PREFIX}who SET has_voted_times = has_voted_times+1 WHERE ip='".$ip."'");
			mysql_query("UPDATE {$properties->DB_PREFIX}who SET lastvote = '".$datevote."' WHERE ip='".$ip."'");
		} else if($can_vote=="no"){
