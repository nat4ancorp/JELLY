<?php
/* VIDEO VOTING SYSTEM (VVS) CORE SYSTEM */
/* VVS STANDS FOR VIDEO VOTING SYSTEM AND IT IS AN "AS IS" SYSTEM FOR CREATING NICE LITTLE 
INTERACTIVE VOTING POLLS OF VIDEOS FOR PEOPLE TO VOTE ON. INCLUDES: JWPLAYER (UNLICENSED, 
BUT CAN ACCEPT LICENSE) VIDEO PLAYER (FOR THE ABILITY TO ACCEPT UPLOADED VIDEOS), ACCEPTS 
MAJOR VIDEO FORMAT: YOUTUBE VIA SOURCE, HAS CUSTOMIZABLE OPTIONS VIA A CONF.PHP FILE, 
AND HAS A NICE LOOK AND FEEL TO IT. 														  */
