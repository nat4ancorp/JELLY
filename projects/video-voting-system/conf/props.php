...
class properties {
	...
	public $WEB_URL					= "http://localhost/JELLY/Nat4andotcom/Versions/Strawberry/projects/video-voting-system/"; 		/* The landing page URL */ // remote: 
	...
	public $DB_USER					= "root"; //remote: mrnat4an_master
	public $DB_PASS					= ""; //remote: thecreation101
	public $DB_NAME					= "_videovotes"; //remote: mrnat4an_videovotes
