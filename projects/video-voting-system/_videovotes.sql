...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2013 at 07:48 PM
...
('admin', 'b739d195ad7192bbd6a223a67645e3a766c239073667821cec0e07257f74410f', 'active', 'no', '', '');
...
(1, 'Original Army Version', '4hpEnLtqUDg', '', 'youtube', 23, 23, 'active'),
(2, 'The Harlem Shake v1 (TSCS original)', '384IUU43bfQ', '', 'youtube', 5, 5, 'active'),
(3, 'BIGGEST Harlem Shake (University of Texas at Austin) Original', 'eTXV4AdZ-dE', '', 'youtube', 7, 7, 'active'),
(4, 'Wedding Harlem Shake (San Antonio, Texas) by Expose the Heart', 'KvO4VEkhqaE', '', 'youtube', 6, 6, 'active');
