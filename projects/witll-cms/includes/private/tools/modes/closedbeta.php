...
$logged_session=$_COOKIE[$properties->_INIT_SESSION];
									...
									if(isset($_POST['login'])){
										...
										<div id="mid-table">
											<div class="mid-table-row">
												...
												<div id="mid-table-midcol">
													<h1 style="font-size:20px;line-height: 1.8em;"><br /><br /><br /><br />Logging in to <?php echo $properties->WEBSITE_NAME.$properties->WEBSITE_EXT;?> Closed BETA Event!</h1>
												</div>
												<div id="mid-table-rightcol">
										...
										<div id="mid-table">
											<div class="mid-table-row">
												...
												<div id="mid-table-midcol">
													<h1 style="font-size:20px;line-height: 1.8em;"><br /><br /><br /><br />Logging out of <?php echo $properties->WEBSITE_NAME.$properties->WEBSITE_EXT;?> Closed BETA Event!</h1>
												</div>
												<div id="mid-table-rightcol">
									...
									switch($_GET['page']){
										...
										if( isset($_POST['recover']) || isset($_POST['theanswer']) ){
											...
											<div id="mid-table">
												<div class="mid-table-row">
													...
													<div id="mid-table-midcol">
														<h1 style="font-size:20px;line-height: 1.8em;"><br />Forget your username? No problem! Fill out the form with the email you used when you registered to become a BETA member and we'll look it up for you.</h1>
													</div>
													<div id="mid-table-rightcol">
											...
											if($num_of_pos_left<1){
												...
												<div id="mid-table">
													<div class="mid-table-row">
														...
														<div id="mid-table-midcol">
															<h1 style="font-size:20px;line-height: 1.8em;">Use this form to submit a request to us if you want to be a BETA Member</h1>
														</div>
														<div id="mid-table-rightcol">
                                        ...
                                        <div id="mid-table">
                                            <div class="mid-table-row">
                                                ...
                                                <div id="mid-table-midcol">
                                                    <h1 style="font-size:20px;line-height: 1.8em;">I'm sorry but this website is open to a limited number of people. If you are a BETA member please login below to use this site</h1>
                                                </div>
                                                <div id="mid-table-rightcol">
                                            ...
                                            <div class="mid-table-row">
                                                ...
                                                <div id="mid-table-midcol">
													...
													?>
													<br />
													<?php if($num_of_pos_left<1){?><h1>We have <?php echo $num_of_pos_left;?> positions open :(</h1><?php }else if(($num_of_pos_left>0) && ($num_of_pos_left<2)){?><h1>We have <?php echo $num_of_pos_left;?> position open!</h1><?php }else if($num_of_pos_left>1){?><h1>We have <?php echo $num_of_pos_left;?> positions open!!!</h1><?php }?>
								...
								if(mysql_num_rows($CHECK_LOGIN)<1){
									...
									<div id="mid-table">
										...
										<div class="mid-table-row">
											...
											<div id="mid-table-midcol">
												<h1 style="font-size:18px;line-height: 1.5em;">Using this panel gives you full access to this site to be able to test it out</h1>
											</div>
											<div id="mid-table-rightcol">
                                        ...
                                        if($num_of_pos_left<1){
                                            ...
                                            <div id="mid-table">
                                                <div class="mid-table-row">
                                                    ...
                                                    <div id="mid-table-midcol">
                                                        <h1 style="font-size:20px;line-height: 1.8em;">Use this form to submit a request to be an Admin or a BETA Member</h1>
                                                    </div>
                                                    <div id="mid-table-rightcol">
