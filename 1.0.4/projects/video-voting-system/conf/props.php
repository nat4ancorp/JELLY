...
class properties {
	/* GENERAL VARIABLES */
	public $TITLE					= "My Video Voting System";	/* Give this voting page a snazzy title! */
	public $DISP_ADMIN_LINK			= "yes";					/* yes - will display the admin link; no - will not display link and you can access the admin from ?page=admin*/
	public $WEB_URL					= "http://www.nat4an.com/projects/video-voting-system/"; /* The landing page URL */	
	...
	public $SHOW_RESULTS_IMM		= "yes"; 					/* When set to yes, the results will show immediately after the person votes or on page load if the user has voted, no will cause no results to be displayed. */
