...
?>
<h2 id="mail-btn" style="display:none;cursor:pointer;">Want to know the latest? Click to add your email to our mailing list today!</h2>
<div id="mailing_popup" style="display:none;" class="fb-popup">
<center>
