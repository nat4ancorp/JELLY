...
if(isset($_POST['set_tou'])){
	...
	if($tou_status=="agree"){
		/* TOU GOOD */
		mysql_query("UPDATE {$properties->DB_PREFIX}users SET in_site='yes' WHERE uname='$username'");
		echo "It looks like you are ready to go. When you are ready, <h2>[<a href=\"".$WEBSITE_URL."\" class=\"white\">Enter ".$properties->WEBSITE_NAME.$properties->WEBSITE_EXT."</a>]</h2>to enjoy the awesomeness of Nat4an!";
