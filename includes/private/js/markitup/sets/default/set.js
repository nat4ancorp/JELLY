...
var nEditorSettings = {
	...
	markupSet:  [ 	
		...
		{	name:'N_TAGs', className:'ntags', dropMenu: [
				{name:'Read More', className:'lorem-special', replaceWith:'[!--more--]' },
				{name:'Base URL', className:'lorem-special', replaceWith:'(baseurl)' },
				{name:'Home Launch Pad', className:'lorem-special', replaceWith:'(homelp)' },
				{name:'Current Launch Pad', className:'lorem-special', replaceWith:'(currentlp)' },
				{name:'Stylesheet', className:'lorem-special', replaceWith:'(stylesheet)' },
				{name:'Entry Name', className:'lorem-special', replaceWith:'(entry_name)' },
