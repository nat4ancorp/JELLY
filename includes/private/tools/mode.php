...
<div id="mid-table-midcol">
<?php
$DISPLAY_STATUS_MESSAGE="<h1>Your account is new and is still under review. Please be patient.</h1>";
...
<div id="mid-table-midcol">
<?php
$DISPLAY_STATUS_MESSAGE="We're sorry but your account has been temporarily suspended due to <b>".$suspended_reason."</b>.";
if(isset($_POST['logout'])){
$username=$_POST['username'];
//FIX AS OF 3.5.1 - This clears the cookie for the new cookie in case something happens
include("includes/private/attributes/cookie_destroyer_user.php");
...
include("includes/private/bin/modules/toolkit.php");

} else if(getGlobalVars($properties,'top_nav_use') == "top navigation w/ search"){

include("includes/private/bin/modules/topnavwithsearch.php");

} else if(getGlobalVars($properties,'top_nav_use') == "top navigation w/o search"){

include("includes/private/bin/modules/topnavwithoutsearch.php");
}
?>
</div>
</div>
...
<div id="container">
<?php
include("includes/private/bin/modules/featureslider.php");
?>
...
?>
<?php
include("includes/private/bin/modules/footer.php");
?>
<?php
} else if($agreed==0){
/* DISAGREED */
...
case 'deleted':
echo "Um...something is a miss. We apparently can't find an account for you. Just log out <a href=\"\">here</a>.";
break;
